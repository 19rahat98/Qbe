    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          child: 
            Text('Recommended Places', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600,fontFamily: 'Poppins', color: Colors.grey[800]),),

          ), 
          rpb.data.isEmpty ? Container(height: 300,child: LoadingWidget1()):
          ListView.builder(
                      primary: false,
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                  Text(rpb.data[index]['place name'], style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.w700),),
                                  Row(
                                    children: <Widget>[
                                      Icon(Icons.location_on, size: 16, color: Colors.grey[400]),
                                      Expanded(child: Text(rpb.data[index]['location'], style: TextStyle(fontSize: 14, color: Colors.grey[400], fontWeight: FontWeight.w600), maxLines: 1, overflow: TextOverflow.ellipsis,),),
