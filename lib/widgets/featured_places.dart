    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          child: 
            Text(' Featured Places', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600,fontFamily: 'Poppins', color: Colors.grey[800]),),

          ), 
        Container(
          height: 280,
          width: w,
          child: pb.data.isEmpty ? LoadingWidget2() :
                  ...
                  child: InkWell(
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                            child: Text(pb.data[index]['location'],
                    ...
                    onTap: () {
                      nextScreen(context, PlaceDetailsPage(
                        ...
                        images: [pb.data[index]['image-1'],pb.data[index]['image-2'],pb.data[index]['image-3']],
                        tag: 'featured$index',
