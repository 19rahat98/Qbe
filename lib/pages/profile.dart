      ...
      appBar: PreferredSize(
        ...
        actions: <Widget>[
          Container(
            ...
            child: FlatButton.icon(onPressed: () => handleLogout(), icon: Icon(LineIcons.sign_out), label: Text('Logout')),
          )
        ],
        ...
        child: ListView(
          children: <Widget>[
            ...
            Align(
                  ...
                  onPressed: (){
                    print(ub.name);
                    nextScreen(context, ProfileEditPage(imageUrl: ub.imageUrl, name: ub.name,));
                  }, 
            ...
            ListTile(
              ...
              title: Text('Name', style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600),),
            ...
            ListTile(
              ...
              title: Text('Member Since', style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600),),
