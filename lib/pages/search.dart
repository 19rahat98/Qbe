                    ...
                    child: SlideAnimation(
                        ...
                        child: FadeInAnimation(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    pb.data[index]['comments count'].toString(),
                                                    style: textStylicon,
                                                  ),
                                                  Spacer(),
                                                ],
                              ...
                              Positioned(
                                  ...
                                  child: Hero(
                                    ...
                                    child: Container(
                                      height: 120,
                                      width: 120,
                                      child: cachedImage(pb.data[index]['image-1'], 10),
                                    ),
                                  ))
                            ],
                          ),
                         ...
                         nextScreen(context, PlaceDetailsPage(
                          ...
                          images: [pb.data[index]['image-1'],pb.data[index]['image-2'],pb.data[index]['image-3'], 10],
                          tag: 'suggestion$index',
                    ...
                    child: SlideAnimation(
                        ...
                        child: FadeInAnimation(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    pb.filteredData[index]['loves'].toString(),
                                                    style: textStylicon,
                                                  ),
                                                  ...
                                                  Text(
                                                    pb.filteredData[index]['comments count'].toString(),
                                                    style: textStylicon,
                                                  ),
                                                  Spacer(),
                                                ],
                              ...
                              Positioned(
                                  ...
                                  child: Hero(
                                    ...
                                    child: Container(
                                      height: 120,
                                      width: 120,
                                      child: cachedImage(pb.filteredData[index]['image-1'], 10),
                                    ),
                                  ))
                            ],
                          ),
                         ...
                         nextScreen(context, PlaceDetailsPage(
                          ...
                          images: [pb.filteredData[index]['image-1'],pb.filteredData[index]['image-2'],pb.filteredData[index]['image-3']],
                          tag: 'filtered$index',
