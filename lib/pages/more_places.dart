        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text('$title Places', style: TextStyle(color: Colors.grey[900], fontSize: 20, fontWeight: FontWeight.w700),
          ...
          SliverList(
            ...
            delegate: SliverChildBuilderDelegate(
              ...
              return InkWell(
                        ...
                        images: [data[index]['image-1'],data[index]['image-2'],data[index]['image-3']],
                        tag: '$title$index',
