...
class BlogDetailsPage extends StatefulWidget {
  ...
  BlogDetailsPage(
      {Key key,
      @required this.title, this.description, this.imageUrl, this.date, this.source, this.loves, this.timestamp, this.tag
      })
      : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Share.share('${widget.title}, To read more install ${Config().appName} App. https://play.google.com/store/apps/details?id=com.pt.lavtrip');
                        },
                      ),
                    ],
                  ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Expanded(child: FlatButton.icon(
                            ...
                            icon:Icon(LineIcons.copyright, size: 20, color: Colors.blueAccent), 
                            label: Expanded(child: Text(widget.source, maxLines: 1, overflow: TextOverflow.ellipsis,)))),
                          IconButton(
                            icon: bb.loveIcon,
                            onPressed: () {
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(width: 3,),
                      Text('${bb.loves.toString()} People love this', style: TextStyle(
                      ...
                      FlatButton.icon(
                        ...
                        onPressed: (){
                          nextScreen(context, CommentsPage(timestamp: widget.timestamp, title: 'Comments',));
                        }, 
