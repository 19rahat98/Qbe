...
class ProfileEditPage extends StatefulWidget {
  ...
  ProfileEditPage({Key key,@required this.imageUrl, this.name}) : super(key: key);

  @override
  _ProfileEditPageState createState() => _ProfileEditPageState(this.imageUrl, this.name);
}
...
class _ProfileEditPageState extends State<ProfileEditPage> {
  ...
  Future pickImage() async {
    var imagepicked = await ImagePicker.pickImage(source: ImageSource.gallery, maxHeight: 200, maxWidth: 200);
  ...
  Future uploadPicture() async {
    ...
    StorageReference storageReference = FirebaseStorage.instance.ref().child('Profile Pictures/$uid');
  ...
  handleSaveData () async {
    ...
    if (ib.hasInternet == false) {
      ...
      : uploadPicture().then((value) => ub.updateNewData(name, imageUrl).then((_) {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Text('Save Data', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
                onPressed: (){
                  handleSaveData();
                },
